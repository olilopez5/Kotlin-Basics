...
// escribe un programa que calcula los precios de estas entradas basándose en la edad:
...
//Un valor de -1para indicar que el precio no es válido cuando un usuario ingresa una
